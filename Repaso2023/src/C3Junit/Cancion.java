...
public class Cancion {
	...
	public JLabel getlDuracion() {
		return lDuracion;
	}
	public void setlDuracion(JLabel lDuracion) {
		this.lDuracion = lDuracion;
	}
	public JProgressBar getPbDuracion() {
		return pbDuracion;
	}
	public void setPbDuracion(JProgressBar pbDuracion) {
		this.pbDuracion = pbDuracion;
	}
	public JButton getbSimular() {
		return bSimular;
	}
	public void setbSimular(JButton bSimular) {
		this.bSimular = bSimular;
	}
	...
	/* Constructor indirecto si lo hubiera
	public static Cancion crear() {
